...
SUPPORTED_DATASETS = ("hopfield",)
RESERVED_DATASETS = ("hamming_ball",)


def _unsupported_dataset_error(dataset_key: str) -> ValueError:
    supported = ", ".join(SUPPORTED_DATASETS)
    reserved = ", ".join(RESERVED_DATASETS)
    return ValueError(
        f"Unsupported dataset '{dataset_key}'. Supported datasets: {supported}. "
        f"Reserved future datasets: {reserved}."
    )
